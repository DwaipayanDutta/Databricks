...
async def list_pipelines(
    ...
    return await service.list_pipelines(max_results, filter)
...
async def list_pipeline_events(
    pipeline_id: str, service: DltService = Depends(get_dlt_service)
) -> dict[str, Any]:
    return await service.list_pipeline_events(pipeline_id)
