...
from databricks_connector.core.constants import CONNECTOR_VERSION
from databricks_connector.schemas.common import HealthStatus, ReadinessStatus
...
@router.get(
    ...
    description=(
        "Verifies the connector is ready to serve traffic: circuit breaker "
        "state, Databricks authentication, Databricks connectivity, and "
